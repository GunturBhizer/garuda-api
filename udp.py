...
for y in range(threads):
    ...
    th.start()
    th = threading.Thread(target = mts)
    th.start()
    th = threading.Thread(target = dm)
    th.start()
    th = threading.Thread(target = ml)
    th.start()
    th = threading.Thread(target = xj)
    th.start()
    th = threading.Thread(target = ux)
    th.start()
    th = threading.Thread(target = ox)
    th.start()
    th = threading.Thread(target = yx)
    th.start()=
